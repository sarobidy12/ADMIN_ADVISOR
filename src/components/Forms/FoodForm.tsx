...
import { addAccompaniment, getAccompaniments, updateAccompaniment } from '../../services/accompaniments';
...
const FoodForm: React.FC<FoodFormProps> = ({
  ...
  const updatePrice = async (data: any) => {
    ...
    const optionSelectIndex = options.findIndex(({ title }) => title === currentAcc?.title);
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          ...
          <Autocomplete
            ...
            options={attributeOptions.filter((items: any) => !items.tag.includes('allergen'))}
            multiple
                ...
                <>
                  ...
                  <Grid container spacing={2}>
                    <DnDList
                      ...
                      setValues={setValues}
                      values={values}
                      accompanimentOptions={accompanimentOptions.filter((item: Accompaniment) => item.restaurant?._id === values.restaurant)}
