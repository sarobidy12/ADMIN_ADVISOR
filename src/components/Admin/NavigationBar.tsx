          ...
          <Badge color="primary" badgeContent={dc + tc + osc}>
            <Tooltip title="Tous">
              <Button
                ...
                startIcon={
                  <ShoppingCartIcon
                    className={dc + tc + osc > 0 ? "pulsate" : "pulsateStop"}
                  />
                }
              ...
              >
                <span className="label">
                  <div
                    className={
                      dc + tc + osc > 0 ? "labelContent" : "labelContentStop"
                    }
                  >
                    Tous
                  </div>
          ...
          <Badge color="primary" badgeContent={dc}>
            <Tooltip title="Livraison">
              <Button
                ...
                startIcon={
                  <LocalShippingIcon
                    className={dc > 0 ? "pulsate" : "pulsateStop"}
                  />
                }
                onClick={handleCommandClick}
              >
                <span className="label">
                  <div className={dc > 0 ? "labelContent" : "labelContentStop"}>
                    Livraison
                  </div>
                </span>
              </Button>
          ...
          <Badge color="primary" badgeContent={tc}>
            <Tooltip title="À emporter">
              <Button
                ...
                startIcon={
                  <ShoppingBasketIcon
                    className={tc > 0 ? "pulsate" : "pulsateStop"}
                  />
                }
                onClick={handleCommandClick}
              >
                <span className="label">
                  <div className={tc > 0 ? "labelContent" : "labelContentStop"}>
                    À emporter
                  </div>
                </span>
              </Button>
          ...
          <Badge color="primary" badgeContent={osc}>
            <Tooltip title="Sur place">
              <Button
                ...
                classes={{ startIcon: "icon" }}
                startIcon={
                  <PlaceIcon className={osc > 0 ? "pulsate" : "pulsateStop"} />
                }
                onClick={handleCommandClick}
              >
                <span className="label">
                  <div
                    className={osc > 0 ? "labelContent" : "labelContentStop"}
                  >
                    Sur place
                  </div>
                </span>
